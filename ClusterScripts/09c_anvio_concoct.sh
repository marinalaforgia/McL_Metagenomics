...
#SBATCH -e anvio_bin_concoct_stderr.txt
#SBATCH -o anvio_bin_concoct_stderr.txt
...
anvi-cluster-contigs -p GL_meta_merged_kaiju_2500bp/PROFILE.db -c GL.db -C CONCOCT --driver concoct -T 48 --just-do-it
